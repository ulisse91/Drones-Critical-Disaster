...
int main(int argc, char **argv)
{
    ...
    simulator sim = simulator(G, n_input.n_drones, n_input.n_drones /* batteries */, n_input.budget, 0, n_input.seed);
    ...
    print::print_e_solution(G, sol_top, sim.sigma_prime_prob);
    ...
    print::print_e_solution(G, sol_greedy_max, sim.sigma_prime_prob);
    ...
    print::print_e_solution(G, sol_greedy_min, sim.sigma_prime_prob);
    ...
    print::print_e_solution(G, sol_prim, sim.sigma_prime_prob);
    ...
    print::print_e_solution(G, top_plus_prim, sim.sigma_prime_prob);
